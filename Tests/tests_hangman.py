...
class TestGame (unittest.TestCase):
    ...
    def test_game_on(self):
        self.assertTrue(hangman.Game_on(5, ['c', '',  't', 'e', 'e', 's'] , ['c', 'a', 't', 'e', 'e', 's']))
        self.assertFalse(hangman.Game_on(6, ['c', '',  't', 'e', 'e', 's'] , ['c', 'a', 't', 'e', 'e', 's']))
        self.assertTrue(hangman.Game_on(5, ['c', 'a',  't', 'e', 'e', 's'] , ['c', 'a', 't', 'e', 'e' 's']))
    ...
    @patch('Hangman.hangman.random_choice', side_effect=['master'])
    @patch('builtins.input', side_effect=['m', 'a', 's', 't', 'e', 'r'])
    @patch('builtins.print')
